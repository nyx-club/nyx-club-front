...
import { events as allEvents, getUpcomingEvents, getPastEvents, eventCategories } from "@/data/events";
...
const EventModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
      <div className="bg-black border border-[#B20118]/30 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
